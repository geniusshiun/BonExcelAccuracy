...
def main():
    ...
    allsubkey.extend(['臺灣','臺鐵','臺北','臺中','臺南','臺東'])
    ouputfilename = 'iBon1231report.xlsx'
    #print(symboleItem)
    ...
    #sys.exit()
    #load excel
    df = pd.read_excel('語音互動詢答1231_0106(iBonPWSTD_stage3_20181206_NG)_0111YH.xlsx')#,header=None
    symbolList = []
